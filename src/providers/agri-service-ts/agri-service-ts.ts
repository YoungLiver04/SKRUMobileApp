...
/*
  Generated class for the AgriServiceTsProvider provider.

  See https://angular.io/docs/ts/latest/guide/dependency-injection.html
  for more info on providers and Angular DI.
*/
@Injectable()
export class AgriServiceTsProvider {
  ...
  apiUrl = this.AppSettingsProvider.getApiUrl();//ดึงข้อมูลมาจาก app set
   ...
   public getnews() {
     ...
     return this.http.get(this.apiUrl + 'news6' )//http://localhost:3000/+news2
