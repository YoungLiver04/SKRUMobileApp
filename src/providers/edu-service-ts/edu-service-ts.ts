...
/*
  Generated class for the EduServiceTsProvider provider.

  See https://angular.io/docs/ts/latest/guide/dependency-injection.html
  for more info on providers and Angular DI.
*/
@Injectable()
export class EduServiceTsProvider {
  ...
  apiUrl = this.AppSettingsProvider.getApiUrl();//ดึงข้อมูลมาจาก app set
   ...
   public getnews() {
     ...
     return this.http.get(this.apiUrl + 'news3' )//http://localhost:3000/+news2
